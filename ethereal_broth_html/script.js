//library = require('~/Data/Documents/GitHub/Ethereal-Broth/module.js');
...
function countPassGenerator(keyword, website){
...
function randPassGenerator(passLength){
        if (passLength < 3) 
            passLength = 3;
